...
class PDF417LicenseScanner {
    constructor() {
        ...
        this.elements = {
            ...
            photoCaptureImg: document.getElementById('photoCapture'),
    ...
    initEvents() {
        ...
        if (this.elements.photoCaptureBtn) {
    ...
    // Captura una fotografía del video y la muestra en <img id="photoCapture">
    capturePhoto() {
        if (!this.state.isCameraActive || !this.elements.video.videoWidth) return;
        ...
        if (this.elements.photoCaptureImg) {
            this.elements.photoCaptureImg.src = dataUrl;
            this.elements.photoCaptureImg.style.display = 'block';
        }
    }
